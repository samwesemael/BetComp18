	 ...
	 <div class="container-fluid">
			 <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    Indien er na puntenverdeling van alle wedstrijden een gelijkstand plaatsvindt zijn dit de volgende criteria waarop je positie in het klassement bepaald wordt: </p> <p>
                                <ol>
                ...
                <p> De gokken zullen worden ingediend op het tabblad Gokken --> matchen. <br>
				Noot:
				<ul> 
...
<li> geel-rood = 4 punten </li> </ul> </li>
...
<li> 1/8ste finale </li>
<li>  groepsfase </li> </ul>
Je gokt het verst je denkt dat ze geraken. </li>
</ol>
